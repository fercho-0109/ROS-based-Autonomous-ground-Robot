...
"""autogenerated by genpy from test_pkg/TimerActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TimerActionFeedback(genpy.Message):
  _md5sum = "16dda32aa9ceaf0614346b6ef6795a4f"
  _type = "test_pkg/TimerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','test_pkg/TimerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = test_pkg.msg.TimerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = test_pkg.msg.TimerFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.partial_time_elapsed
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.partial_time_elapsed,) = _get_struct_f().unpack(str[start:end])
      return self
