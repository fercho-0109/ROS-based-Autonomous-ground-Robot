...
"""autogenerated by genpy from test_pkg/TimerActionResult.msg. Do not edit."""
import codecs
import sys
...
class TimerActionResult(genpy.Message):
  _md5sum = "1988989e269a79db6274cae617d420cf"
  _type = "test_pkg/TimerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','test_pkg/TimerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = test_pkg.msg.TimerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = test_pkg.msg.TimerResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.result.total_time_elapsed
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.total_time_elapsed,) = _get_struct_f().unpack(str[start:end])
      return self
