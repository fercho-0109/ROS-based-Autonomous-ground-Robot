...
"""autogenerated by genpy from test_pkg/WordCountRequest.msg. Do not edit."""
import codecs
import sys
...
class WordCountRequest(genpy.Message):
  ...
  _type = "test_pkg/WordCountRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# WordCount.srv
string words #input
"""
  __slots__ = ['words']
  _slot_types = ['string']
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test_pkg/WordCountResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class WordCountResponse(genpy.Message):
  ...
  _type = "test_pkg/WordCountResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """uint32 count #output
