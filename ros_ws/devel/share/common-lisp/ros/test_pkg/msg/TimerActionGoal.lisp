...
(cl:defclass <TimerActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type test_pkg-msg:TimerGoal
    :initform (cl:make-instance 'test_pkg-msg:TimerGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TimerActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimerActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_pkg-msg:<TimerActionGoal> is deprecated: use test_pkg-msg:TimerActionGoal instead.")))
...
(cl:defmethod goal_id-val ((m <TimerActionGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_pkg-msg:goal_id-val is deprecated.  Use test_pkg-msg:goal_id instead.")
  (goal_id m))

(cl:ensure-generic-function 'goal-val :lambda-list '(m))
(cl:defmethod goal-val ((m <TimerActionGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_pkg-msg:goal-val is deprecated.  Use test_pkg-msg:goal instead.")
  (goal m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TimerActionGoal>)))
  ...
  "a28a0db277330dcb24b71acba2daa259")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TimerActionGoal)))
  "Returns md5sum for a message object of type 'TimerActionGoal"
  "a28a0db277330dcb24b71acba2daa259")
